...
void  YetkiliIslem:: musteriEkle() 
{
	...
	cout<<"Bakiye (TL)  : "; scanf("%f", &sayi  ); m1.setBakiye(sayi ) ;
...
void  YetkiliIslem:: musteriSil()
{
	...
	else 
	{
		...
		/*cout<<"Sube Adi     : "<< m1.getSubeAd( ) << endl ;
		cout<<"Sube Adres   : "<< m1.getSubeAdres( ) << endl ;*/
		...
		cout<<"Musteri kaydini silmek istediginize emin misiniz ? [E/H] : "; cin>>tercih; 
